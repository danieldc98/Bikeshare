...
(function($) {
	...
	skel.init({
		reset: 'full',
		breakpoints: {
			global:		{ range: '*', href: "{% static 'biketrip/css/style.css' %}", containers: 1400, grid: { gutters: 50 } },
			wide:		{ range: '-1680', href: "{% static 'biketrip/css/style-wide.css' %}", containers: 1200, grid: { gutters: 40 } },
			normal:		{ range: '-1280', href: "{% static 'biketrip/css/style-normal.css' %}", containers: 960, lockViewport: true },
